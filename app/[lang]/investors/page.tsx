...
const meta: Record<Locale, Metadata> = {
  ...
  es: {
    title: "Relación con Inversionistas — NitricX",
    description:
      "NitricX es una bebida premium de rendimiento a base de plantas enfocada en el mercado global de bebidas energéticas de $24B. Fórmula registrada, alianzas en la industria y una red completa de distribución minorista.",
  },
};

export async function generateMetadata({ params }: PageProps<"/[lang]/investors">): Promise<Metadata> {
